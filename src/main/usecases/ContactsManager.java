...
//
//    private Map<String, ArrayList<String>> contactListsofUsers;
//
//    /**
//     * A user is added to the contact manager system with user id(String). The initial contact list of
...
//     */
//    public void addUser(String userid, String friendid) {
//        ArrayList<String> friend1 = contactListsofUsers.get(userid);
//        friend1.add(friendid);
//        contactListsofUsers.put(userid, friend1);
//        ArrayList<String> friend2 = contactListsofUsers.get(friendid);
//        friend2.add(userid);
...
//     */
//    public void removeUser(String userid, String friendid){
//        ArrayList<String> friend1 = contactListsofUsers.get(userid);
...
//     */
//    public boolean checkPermission(String userid, String friendid){
//        ArrayList<String> friend1 = contactListsofUsers.get(userid);
...
//     * @return a Map of users and their contact lists saved in ContactsManager
//     */
//    public Map<String, ArrayList<String>> getUsersSaved(){
